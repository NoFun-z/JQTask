    ...
    public partial class MigrationAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListBoards", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListBoardID = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuyerID", x => x.ID);
                    table.ForeignKey(
                        name: "FK_BuyerID_ListBoards_ListBoardID",
                        column: x => x.ListBoardID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskList_ListBoards_ListBoardID",
                        column: x => x.ListBoardID,
                        principalTable: "ListBoards",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
